        ...
        {duplicatedItems.map((item, idx) => (
          ...
          >
            ...
            <div className="h-full flex flex-col">
              ...
              <p
                className={`text-gray-600 text-xs md:text-sm leading-relaxed flex-grow transition-all duration-300 ${
            ...
            {/* 3D Shadow Effect */}
            <div
              className={`absolute inset-0 rounded-xl bg-gradient-to-br from-[#21d6e0]/10 to-transparent transition-all duration-500 ${
