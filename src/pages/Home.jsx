        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto leading-relaxed">
              ...
              technology, bringing together global leaders to shape the future
              of flight.
            </p>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-gray-600 text-center max-w-2xl mx-auto mb-12">
            Discover the scale and impact of the premier aviation marketing
            event
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20 transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
              ...
              <p className="mb-6 opacity-90">
                Secure your spot at the premier aviation marketing summit
              </p>
              <Link
                to="/registration"
            ...
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20 transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
              ...
              <p className="mb-6 opacity-90">
                Showcase your innovations to global aviation leaders
              </p>
              <Link
                to="/sponsorship"
                className="inline-block bg-white text-blue-900 px-6 py-3 rounded-lg font-semibold hover:bg-blue-50 transition"
            ...
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20 transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
              ...
              <p className="mb-6 opacity-90">
                Apply for prestigious aviation marketing awards
              </p>
              <Link
                to="/awards"
                className="inline-block bg-white text-blue-900 px-6 py-3 rounded-lg font-semibold hover:bg-blue-50 transition"
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
                ...
                <div className="bg-blue-100 p-3 rounded-full mr-4 flex-shrink-0">
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth="2"
                      d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 极 3 0 016 0zm6 极a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"
                    />
                  </svg>
                </div>
                <div>
                  ...
                  <p className="text-gray-600">
                    Connect with top executives and decision-makers from leading
                    aviation companies
                  </p>
                </div>
              </div>
                ...
                <div className="bg-blue-100 p-3 rounded-full mr-4 flex-shrink-0">
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth="2"
                      d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 极 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"
                    />
                  </svg>
                </div>
                <div>
                  ...
                  <p className="text-gray-600">
                    Gain access to the latest trends and innovations in aviation
                    marketing
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-xl font-semib极 mb-2">
                    Strategic Partnerships
                  </h3>
                  <p className="text-gray-600">
                    Forge valuable partnerships that drive business growth and
                    innovation
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Engage in hands-on workshops and dynamic panel discussions
                  </p>
                </div>
              </div>
            </div>
