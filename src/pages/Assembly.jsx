  ...
  const roles = [
    {
      ...
      description:
        "C-level executives from leading airlines redefining passenger experience and unlocking growth frontiers",
      icon: (
        <svg
          className="w-8 h-8"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Heads of loyalty focused on building unbreakable brand relationships and seamless passenger experiences",
      icon: (
        <svg
          className="w-8 h-8"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Leaders in revenue optimization, e-commerce, and digital marketing seeking profitability solutions",
      icon: (
        <svg
          className="w-8 h-8"
          fill="none"
    ...
    },
    {
      ...
      description:
        "IT professionals implementing cutting-edge technologies to modernize airline operations",
      icon: (
        <svg
          className="w-8 h-8"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Minds behind disruptive innovations in AI, sustainable propulsion, and data security",
      icon: (
        <svg
          className="w-8 h-8"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Policymakers guiding industry evolution, ensuring secure, efficient global framework",
      icon: (
        <svg
          className="w-8 h-8"
          fill="none"
      ...
      <section className="bg-gradient-to-r from-blue-900 to-blue-700 text-white py-24 mt-20">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            An Assembly of Architects
          </h1>
          <p className="text-xl max-w-3xl mx-auto">
            IAMS 2026 is a carefully curated assembly of individuals shaping the
            very fabric of modern aviation.
          </p>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4 py-12">
              ...
              >
                <div className="flex items-start mb-4">
                  <div className="bg-blue-100 p-3 rounded-lg mr-4 flex-shrink-0">
                    <div className="text-blue-700">{role.icon}</div>
                  </div>
                  <div>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-2xl p-8 text-white">
          ...
          <div className="text-center mt-8 pt-6 border-t border-white border-opacity-20">
            <p className="text-lg">
              Join the most influential gathering of aviation professionals
