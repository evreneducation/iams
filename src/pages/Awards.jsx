...
const Awards = () => {
  ...
  const benefits = [
    {
      ...
      icon: (
        <svg className="w-8 h-8 text-[#15A4B3]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const galaInfo = [
    { label: "Date", value: "April 9, 2026", icon: (
      <svg className="w-6 h-6 text-[#15A4B3]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    { label: "Venue", value: "Holiday Inn New Delhi Aerocity ", icon: (
      <svg className="w-6 h-6 text-[#15A4B3]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    { label: "Tickets", value: "Included in the IAMS 2026 Pass", icon: (
      <svg className="w-6 h-6 text-[#15A4B3]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const stats = [
    { value: "Gain International Recognition", label: "Showcase your achievements on a global stage." },
    { value: "Extensive Media Coverage", label: "Be featured across leading aviation media and partner networks." },
    { value: "Network with Industry Elite", label: "Engage with airline leaders at the exclusive Gala Night." },
    { value: "Motivate Your Team", label: "Boost employee morale and strengthen your organization's reputation for excellence." }
  ];
    ...
    <div className="w-full overflow-x-hidden">
      ...
      <section className="py-16 bg-[#E6F7F9]">
        <div className="max-w-7xl mx-auto px-6">
          <p className="text-lg md:text-xl max-w-3xl mx-auto mb-10 text-gray-700">
            Where achievement meets prestige — the IAMS Awards Gala celebrates visionary teams and groundbreaking innovations transforming global aviation’s commercial landscape.
          </p>
          <h2
      ...
      <section className="max-w-[1400px] mx-auto px-6 py-20 grid grid-cols-1 lg:grid-cols-2 gap-12">
        <div className="space-y-6">
          <h2 className="text-4xl font-bold mb-6" style={{ color: "#15A4B3" }}>
          ...
          {benefits.map((b, i) => (
            ...
            >
              <div className="p-4 rounded-full mr-5 flex items-center justify-center text-2xl"
                style={{ backgroundColor: "rgba(21,164,179,0.15)", color: "#15A4B3" }}>
                {b.icon}
              </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-10 space-y-6 border border-gray-100">
          <h2 className="text-4xl font-bold text-center" style={{ color: "#15A4B3" }}>
            Gala Information
          </h2>
          {galaInfo.map((item, idx) => (
            <div key={idx} className="flex items-center gap-4 p-3 rounded-xl hover:bg-[#E6F7F9] transition">
      ...
      <section
        ...
        style={{ background: "linear-gradient(135deg, #f4f8f9ff 0%, #f8fbfbff 100%)" }}
      >
  ...
  <div className="w-24 h-1 bg-white mx-auto rounded-full"></div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto" >
          {categories.map((cat, index) => (
            ...
            style={{ background: "linear-gradient(135deg, #0E7785 0%, #15A4B3 100%)" }}
            >
...
<section className="py-16 px-6 md:px-12 bg-white text-white">
 ...
 <div className="text-center mb-12">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
    ...
    >
      <h3
        className="text-xl font-semibold mb-2 bg-clip-text text-transparent text-white"
       
      >
        Eligibility
      </h3>
      <p className="text-white text-sm leading-relaxed">
        Open to global airlines, airports, technology providers, and travel partners.
      </p>
    </div>
    ...
    >
      ...
      <p className="text-white text-sm leading-relaxed">
        Innovation & Creativity | Impact & Results | Scalability | Industry Relevance.
      </p>
    </div>
    ...
    >
      ...
      <button className="bg-gradient-to-r from-[#0E7785] to-[#15A4B3] text-white font-semibold px-5 py-2 rounded-full hover:scale-105 transition-transform duration-300 shadow-md"
       onClick={()=>{
      ...
      {/* CTA Section */}
      <section
        className="w-full py-20 text-white text-center rounded-3xl transform transition-transform duration-500 hover:scale-105 shadow-xl"
        style={{ background: "linear-gradient(135deg, #15A4B3 0%, #0E7785 100%)" }}
      >
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-6 px-6">
          <button
            className="border-2 text-white px-8 py-4 rounded-2xl font-semibold text-lg hover:bg-white hover:text-[#15A4B3] hover:scale-105 transition transform shadow-lg"
