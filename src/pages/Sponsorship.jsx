...
const Sponsorship = () => {
  ...
  const stats = [
    { value: "Forge Strategic Partnerships", label: "Connect with top decision makers from airline marketing, revenue, loyalty and more." },
    { value: "Showcase Industry Leadership", label: "Demonstrate your cutting-edge solutions on a global stage." },
    { value: "Generate Qualified Leads", label: "Access a highly targeted audience actively seeking new technologies and partners." },
    { value: "Gain Actionable Intelligence", label: "Immerse your team in sessions that reveal upcoming trends and market opportunities." }
  ];
            ...
            {stats.map((stat, index) => (
              ...
              >
                <div
                  ...
                  style={{
                    background: "linear-gradient(to right, rgb(21, 164, 179), rgb(15, 130, 142))",
            ...
            Strategic Partnerships
              ...
              <div className="space-y-6">
                {[
                  ...
                  >
                    <div className="p-3 rounded-full flex items-center justify-center" style={{ backgroundColor: "rgba(21,164,179,0.1)" }}>
                      {item.icon}
                    </div>
                    <div>
                      <h3 className="text-xl font-semibold mb-2" style={{ color: "rgb(21, 164, 179)" }}>{item.title}</h3>
        ...
        <div className="mb-16" data-aos="zoom-in">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {packages.map((pkg, index) => (
              <div
                key={index}
                className={`bg-white p-8 rounded-lg shadow-md border border-gray-200 flex flex-col h-full transform transition-all duration-300 hover:scale-105 ${pkg.featured ? 'ring-2 ring-opacity-50 relative' : ''}`}
                style={pkg.featured ? { boxShadow: "0 0 0 2px rgba(21,164,179,0.5)" } : {}}
              >
                {pkg.featured && (
                  <div
                ...
                <h3 className="text-2xl font-bold mb-2 text-center" style={{ color: "rgb(21, 164, 179)" }}>
                  {pkg.name}
                </h3>
